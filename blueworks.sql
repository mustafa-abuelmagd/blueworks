...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1843427856ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blueworks&table=clock_ins">`blueworks`.`clock_ins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blueworks&table=workers">`blueworks`.`workers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Eleshop&table=suppliers">`Eleshop`.`suppliers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Eleshop&table=order_estimated_dates">`Eleshop`.`order_estimated_dates`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Eleshop&table=orders">`Eleshop`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Eleshop&table=order_items">`Eleshop`.`order_items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Eleshop&table=menu_items">`Eleshop`.`menu_items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Eleshop&table=orders_estimated_dates">`Eleshop`.`orders_estimated_dates`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=Eleshop&table=supplier_items">`Eleshop`.`supplier_items`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="68245a775b5c382e4c66336e7c463036">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="blueworks" targettable="clock_ins">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `clock_ins`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blueworks" targettable="clock_ins">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `clock_ins`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="blueworks" targettable="workers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `workers`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blueworks" targettable="workers">
                            <div class="action_content">
